...
public class Main {
    public static void main(String[] args) {
        ...
        House woodenHouse =   director.createHouse(); //Строит дом согласно переданному строителю
        House stoneHouse = director.createNewHouse(builderStone); //В параметре принимает нового строителя и сразу же строит дом.
    }
}